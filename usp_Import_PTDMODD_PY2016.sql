...
--
-- Exec usp_Import_PTDMODD_PY2016 'Your path' , 'your filename'
--

CREATE PROCEDURE dbo.usp_Import_PTDMODD_PY2016 @path As VarChar(512), @ImportFileName As VarChar(512)
AS
BEGIN
...
Insert	Into tbl_PTDMODD_PY2016_Header
...
Insert	Into tbl_PTDMODD_PY2016_Record
Select	SubString([Column 0],001,001) As	RecordTypeCode		-- 2,4 or 5
,		SubString([Column 0],002,012) As	BeneficiaryIdentifier
...
,		SubString([Column 0],164,005) As	Filler
,		@ImportFileName As ImportFileName
,		@DateImported As ImportDate
From	tbl_PTDMODD_In
...
-- Get Trailer Record
Insert	Into tbl_PTDMODD_PY2016_Trailer
